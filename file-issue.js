// Modified from https://resources.whatwg.org/file-issue.js
//
// Usage: include a link like `<a href="https://github.com/{github-name}/{my-repo}/issues/new">file an issue</a>`, or give it
...
(function () {
  ...
  fileLink.innerHTML = 'File issue with<br/>selected text';
  ...
  // Get base url for filing issues.
  ...
  // Find nearest parent/sibling node with an ID.
